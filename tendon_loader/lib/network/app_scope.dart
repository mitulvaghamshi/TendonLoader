...
final class AppScope extends InheritedWidget {
  ...
  bool updateShouldNotify(covariant InheritedWidget oldWidget) =>
      oldWidget is AppScope &&
      (data.api != oldWidget.data.api ||
          data.api.settings != oldWidget.data.api.settings ||
          data.api.prescription != oldWidget.data.api.prescription ||
          data.api.excercise != oldWidget.data.api.excercise);
}
