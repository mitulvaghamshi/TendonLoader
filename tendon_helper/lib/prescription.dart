...
class Prescription {
  ...
  String toMapJson(String userId) {
    return 'INSERT INTO Prescription ("exercise_id", "user_id", "reps", "sets", "set_rest", "hold_time", "rest_time", "mvc_duration", "target_load") VALUES ($exID, "$userId", $reps, $sets, $setRest, $holdTime, $restTime, $mvcDuration, $targetLoad);';
  }
}
