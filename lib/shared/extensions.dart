...
extension ExTimeFormat on double {
  String get toTime =>
      '🕒 ${this ~/ 60}:${(this % 60).toStringAsFixed(0).padLeft(2, '0')} Sec';

  String get toRemaining => 'Remaining: ${(5 - this).toStringAsFixed(1)} Sec';
}

extension ExConvert on List<int> {
  double get toWeight => double.parse((Uint8List.fromList(this)
          .buffer
          .asByteData()
  ...
  double get toTime => double.parse((Uint8List.fromList(this)
              .buffer
              .asByteData()
