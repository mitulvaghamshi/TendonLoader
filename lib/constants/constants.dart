...
const String keyKeepLoggedIn = 'keep_logged_in';
const String keyOldUserEmail = 'old_user_email';
...
// datetime
const String keyDateFormat = 'y-MM-dd';
const String keyTimeFormat = 'hh:mm:ss a';
const String keyDateTimeFormat = '$keyDateFormat $keyTimeFormat';
