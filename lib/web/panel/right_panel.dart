                              ...
                              tiles: exports.entries.map((MapEntry<String, dynamic> _time) {
                                ...
                                return ListTile(
                                  ...
                                  leading: TextAvatar(
                                    ...
                                    color: _isMVC ? Colors.green : Colors.amber,
                                  ),
                                  onTap: () {},
                                  trailing: Row(
                                      ...
                                      CustomButton(
                                        ...
                                        onPressed: () async => showDialog<void>(
                                          ...
                                          builder: (_) {
                                            ...
                                            final Prescription prescription = _isMVC
                                                ? null
                                                : Prescription.fromMap(
                                                    _time.value[Keys.KEY_META_DATA] as Map<String, dynamic>);

                                            final List<ChartData> data = List<Map<String, dynamic>>.from(
                                                    _time.value[Keys.KEY_USER_DATA] as List<dynamic>)
