...
class CustomGraph extends StatefulWidget {
  const CustomGraph({Key? key, required this.title, required this.handler, required this.builder}) : super(key: key);
      ...
      body: AppFrame(
        ...
        child: Column(children: <Widget>[
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: <Widget>[
            CustomButton(rounded: true, left: const Icon(Icons.play_arrow), onPressed: widget.handler.start),
            if (widget.handler is ExerciseHandler)
              CustomButton(rounded: true, left: const Icon(Icons.pause), onPressed: widget.handler.pause),
            CustomButton(rounded: true, left: const Icon(Icons.stop), onPressed: widget.handler.stop),
          ]),
        ]),
      ),
    );
